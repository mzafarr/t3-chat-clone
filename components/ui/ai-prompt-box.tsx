...
const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(({ className, ...props }, ref) => (
  <textarea
    className={cn(
      "flex w-full rounded-md border-none bg-transparent px-3 py-2.5 text-base placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-0 disabled:cursor-not-allowed disabled:opacity-50 min-h-[44px] resize-none scrollbar-thin scrollbar-thumb-[#444444] scrollbar-track-transparent hover:scrollbar-thumb-[#555555]",
      "text-foreground dark:text-gray-100 dark:placeholder:text-gray-400",
      className,
    )}
    ref={ref}
    rows={1}
      ...
      <TooltipProvider>
        ...
        >
          <div
            ref={ref}
            className={cn(
              "rounded-3xl border bg-background p-2 shadow-[0_8px_30px_rgba(0,0,0,0.24)] transition-all duration-300",
              "border-border dark:border-[#444444] dark:bg-[#1F2023]",
...
interface PromptInputBoxProps {
  onSend?: (message: string, files?: File[], options?: { search?: boolean; think?: boolean; canvas?: boolean }) => void
  isLoading?: boolean
  placeholder?: string
  className?: string
